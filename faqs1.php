			...
			<legend>Frequently Added Questions</legend>
				...
				<hr>
					<h3>WHEN WILL I GET MY ORDERS?</h3>
						<p style="text-indent:60px;">We wil ship your product 2-3 days in north india and 4-5 days in south india.</p>
				<hr>
					<h3>HOW DO I PAY MY ORDERS?</h3>
					<p style="text-indent:60px;">cash on delivery and UPI.</p>
