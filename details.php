...
<div id="container">
    ...
    <div style="flex: 1.5;">
        <h3 class="text-uppercase bg-primary"><?php echo $row['product_name']?></h3>
        <p class="text-uppercase"><strong>RS <?php echo $row['product_price']?></strong></p>
        <h4 class="text-uppercase"><strong>Size:</strong>
		<select name="size" required style="width:60px;">             
            <option value="">--</option>
            <option value="8" <?php if ($row['product_size'] == '8') echo 'style="color: green;"';?>>8</option>
            <option value="9" <?php if ($row['product_size'] == '9') echo 'style="color: green;"';?>>9</option>
            <option value="10" <?php if ($row['product_size'] == '10') echo 'style="color: green;"';?>>10</option>
            <option value="11" <?php if ($row['product_size'] == '11') echo 'style="color: green;"';?>>11</option>
            <option value="12" <?php if ($row['product_size'] == '12') echo 'style="color: green;"';?>>12</option>
        </select>
        </h4>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Shoe Track Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Shoe Track Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
