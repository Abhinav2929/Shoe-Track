...
<div id="container">
    ...
    <div id="content">
			<legend><h2>Order Placed</h2></legend>
<br>
			<h4>Your order has been placed  on this detailes</h4><br>
            <table>
								<tr>
									<td class="profile">Name:</td><td class="profile"><?php echo $fetch['firstname'];?>&nbsp;<?php echo $fetch['mi'];?>&nbsp;<?php echo $fetch['lastname'];?></td>
								</tr>
							...
							<h4>Your Order will arrive in 3-4 days</h4><br>


            <a href='home.php' class='btn btn-inverse btn-lg'>See Other Items</a>
		</div>
