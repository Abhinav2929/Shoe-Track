...
if (isset($_SESSION['cart']))
	...
	$total=$total+$line_cost;
		...
		echo "<td><p>".$product_size."</p></td>";
		echo "<td><p><input type='hidden' required value='".$x."' name='qty[]'> ".$x."</p></td>";
		echo "<td><p>".$price."</p></td>";
		echo "<td><p><a href='cart.php?id=".$id."&action=add'><i class='icon-plus-sign'></i></a></td>";
		echo "<td><p><a href='cart.php?id=".$id."&action=remove'><i class='icon-minus-sign'></i></a></td>";
		echo "<td><p>Rs ".$line_cost."</p>";
		echo "</tr>";
		}
		...
		echo "<td><input type='hidden' value='".$total."' required name='total'><h4 class='text-danger'>Rs ".$total."</h4></td>";
		echo "<td></td>";
