	...
	<script>
        function confirmOrder() {
            if (confirm("Are you sure you want to place this order?")) {
                window.location.href = "checkout.php"; // Redirect to checkout page after confirmation
            } else {
                // If user cancels, do nothing or redirect to homepage, etc.
            }
        }
    </script>
	<script>
        function confirm_Order() {
            if (confirm("Are you sure you want to place this order?")) {
                window.location.href = "confirmation.php"; // Redirect to checkout page after confirmation
            } else {
                // If user cancels, do nothing or redirect to homepage, etc.
            }
        }
...
<div id="container">
	...
	<label style="font-size:25px;">Summary of your Order</label>
		<tr>
...
<div class="">
	...
	<button onclick="confirmOrder()" class='btn btn-inverse btn-lg'>Upi</button>
</form>
<button onclick="confirm_Order()" class='btn btn-inverse btn-lg'>Cash On Delivery</button>
</div>
	</div>
